using System;
using UnityEngine;
using Mathf = TenTen.Utilities.Mathf;
...
namespace TenTen
{
    public class BoardView : MonoBehaviour
    {
        ...
        {
            int roundedX = Mathf.RoundToInt(localPosition.x, MidpointRounding.AwayFromZero);
            int roundedY = Mathf.RoundToInt(localPosition.y, MidpointRounding.AwayFromZero);
